  ...
  */
  ...
  let html = `
    <li class="select-none mt-2 py-2 border-b border-amber-300">
      ...
      <input id="default-checkbox" value="${id}" type="checkbox" onchange="updateTask(${id}, event)"
      class="inline-block text-xs rounded-md bg-pink-400 hover:bg-pink-500 py-1 px-3 rounded-md ml-2 mr-4"`
